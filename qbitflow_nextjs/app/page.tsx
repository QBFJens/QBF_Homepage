  ...
  return <div className="tech-panel relative rounded-[2rem] p-4">
    <div className="relative h-[28rem] overflow-hidden rounded-3xl">
      <img
        ...
        alt="QBITFLOW preparation chamber quantum hardware"
